...
// }
//
// document.getElementsById("#FindLocation").addEventListener('click', geoFindMe);
//
...
getGeolocation = (lat, lng) => {
  ...
  fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${latlng}&key=AIzaSyDdQZD8XwbxVf2U583hH-TioS5kD9M7bY0&callback=initMap`)
